# All of the graphs in this chapter have been visualizing statistics within one year. Now that you're able to use faceting, however, you can create a graph showing all 
# the country-level data from 1952 to 2007, to understand how global statistics have changed over time.
