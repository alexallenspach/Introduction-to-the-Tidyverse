# There are many other options for customizing a ggplot2 graph, which you can learn about in other DataCamp courses. You can also learn about them from online resources,
...
ggplot(gapminder_1952, aes(x = continent, y = gdpPercap)) +
  ...
  theme(plot.title = element_text(hjust = 0.5)) # This line centers title
